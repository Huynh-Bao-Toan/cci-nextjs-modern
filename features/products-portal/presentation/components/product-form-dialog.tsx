...
import { useCreateProductMutation } from "@/features/products-portal/presentation/hooks/use-create-product-mutation";
import { useUpdateProductMutation } from "@/features/products-portal/presentation/hooks/use-update-product-mutation";
    ...
    try {
      if (isEdit && editingProduct) {
        const input: UpdateProductInput =
          updateProductInputSchema.parse(values);
        ...
        const input: CreateProductInput =
          createProductInputSchema.parse(values);
