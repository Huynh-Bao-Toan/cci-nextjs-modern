...
import { getDefaultProductsSearchParams, parseProductsSearchParams } from "@/features/products-portal/lib/products.params"
import { productsQueries } from "@/features/products-portal/lib/products.queries"
import { ProductsPortalPage } from "@/features/products-portal/components/products-page.client"
...
export default async function ProductsPortalRoute({
  ...
  const params =
    parseProductsSearchParams(resolvedSearchParams) ?? getDefaultProductsSearchParams()
