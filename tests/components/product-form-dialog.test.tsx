...
vi.mock("@/components/ui/select", () => ({
  ...
  SelectItem: ({
    ...
    <button
      type="button"
      onClick={() =>
        (globalThis as GlobalWithSelectMock).__onValueChange?.(value)
      }
    >
      {children}
    </button>
...
import { ProductFormDialog } from "@/features/products-portal/presentation/components/product-form-dialog";
